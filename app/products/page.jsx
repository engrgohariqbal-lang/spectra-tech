...
export const metadata = {
  title: "Products",
  description:
    "Explore our range of analytical instruments including OES, XRF, EDXRF and Carbon-Sulfur analyzers.",
};
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-slate-600">
            Comprehensive analytical solutions from Wuxi Jinyibo Instrument
            Technology.
          </p>
        </div>
