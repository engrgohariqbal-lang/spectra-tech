...
export const metadata = {
  title: "Contact Us",
  description: "Get in touch with SpectraTech Solutions for inquiries, sales, and service.",
};
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300">
              We're here to answer any questions you have about our products or services.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-8 max-w-6xl mx-auto">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href={`tel:${siteConfig.contact.phone.replace(/[^+\d]/g, "")}`} className="text-slate-600 text-sm hover:text-primary transition-colors block">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${siteConfig.contact.email}`} className="text-slate-600 text-sm hover:text-primary transition-colors block">
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden h-[300px] relative">
                ...
                */}
                <div className="absolute inset-0 bg-slate-200 flex flex-col items-center justify-center text-slate-500">
                  ...
                  <span className="font-medium text-lg">Map View Placeholder</span>
            ...
            <div className="w-full lg:w-7/12">
              <div className="bg-white p-8 md:p-12 rounded-2xl shadow-lg border border-slate-100 h-full">
                <h2 className="text-3xl font-bold text-slate-900 mb-2">Leave a Message</h2>
