    ...
    models: [
      {
        ...
        gallery: ["/images/products/crms/sus-certified-reference-materials.webp"],
        description: "Premium SUS Certified Reference Materials designed to provide accurate calibration and quality control for your analytical instruments. These standards are carefully manufactured and certified to ensure the highest level of precision for elemental analysis.",
        features: [
      ...
      },
      {
        ...
        gallery: ["/images/products/crms/mbh-certified-reference-materials.webp"],
        description: "MBH Analytical reference materials are globally recognized for their reliability in optical emission and X-ray fluorescence spectroscopy. Ideal for verifying equipment performance and routine quality control.",
        features: [
      ...
      },
      {
        ...
        tagline: "Brammer Standard reference materials for metallurgical analysis",
        image: "/images/products/crms/bs-certified-reference-materials.webp",
        gallery: ["/images/products/crms/bs-certified-reference-materials.webp"],
        description: "Brammer Standard (BS) Certified Reference Materials are essential for establishing the analytical traceability of solid metal analyses. Our supply covers various matrices to suit your testing requirements.",
        features: [
      ...
      },
      {
        ...
        gallery: ["/images/products/crms/armi-certified-reference-materials.webp"],
        description: "ARMI Certified Reference Materials provide highly accurate elemental compositions. These standards are crucial for laboratories seeking to maintain strict quality assurance and control over their metallurgical processes.",
        features: [
      ...
      },
      {
        ...
        gallery: ["/images/products/crms/alcoa-certified-reference-materials.webp"],
        description: "ALCOA Certified Reference Materials are specifically developed for the aluminum industry. They offer precise calibration standards for testing primary aluminum and aluminum-based alloys.",
        features: [
      ...
      },
      {
        ...
        gallery: ["/images/products/crms/alcan-certified-reference-materials.webp"],
        description: "ALCAN Certified Reference Materials ensure your spectrometers are perfectly calibrated for aluminum analysis. These standards represent a wide array of aluminum alloy grades.",
        features: [
      ...
      {
        name: "Polishing Cloth for Metallographic Polishing",
        tagline: "High-quality cloth for flawless surface preparation",
        image: "/images/products/crms/polishing-cloth-for-metallographic-polishing.webp",
        gallery: ["/images/products/crms/polishing-cloth-for-metallographic-polishing.webp"],
        description: "Achieve the perfect mirror finish on your metallographic samples with our premium polishing cloths. Designed to work seamlessly with diamond pastes and slurries for scratch-free results.",
        features: [
          "Durable and tear-resistant fabric",
          "Optimized for various polishing suspensions",
          "Available in multiple diameters"
        ],
        specs: {
          "Material": {
            "Type": "Woven/Flocked/Synthetic",
            "Application": "Final polishing"
          }
        }
      },
      {
        name: "Metallographic Grinding Sandpaper For Sample Preparation",
        tagline: "Consistent abrasion for flat sample surfaces",
        image: "/images/products/crms/metallographic-grinding-sandpaper-for-sample-preparation.webp",
        gallery: ["/images/products/crms/metallographic-grinding-sandpaper-for-sample-preparation.webp"],
        description: "Our silicon carbide grinding sandpapers provide uniform material removal, essential for preparing flat and deformation-free surfaces for subsequent polishing and analysis.",
        features: [
          "High-quality silicon carbide abrasive",
          "Water-resistant backing for wet grinding",
          "Various grit sizes available (P120 to P2500)"
        ],
        specs: {
          "Abrasive": {
            "Material": "Silicon Carbide (SiC)",
            "Backing": "Plain or PSA (Adhesive)"
          }
        }
      },
      {
        name: "Sharp Fast Cutting Wheel for Metal and Inox",
        tagline: "Efficient and clean sectioning of metallurgical samples",
        image: "/images/products/crms/sharp-fast-cutting-wheel-for-metal-and-inox.webp",
        gallery: ["/images/products/crms/sharp-fast-cutting-wheel-for-metal-and-inox.webp"],
        description: "Designed for abrasive cut-off machines, these sharp cutting wheels ensure fast, cool cutting of metals and stainless steel (Inox) with minimal structural deformation to the sample.",
        features: [
          "Reduced heat generation during cutting",
          "Clean cuts with minimal burr formation",
          "Reinforced for safety and durability"
        ],
        specs: {
          "Application": {
            "Material": "Steel, Stainless Steel, Alloys",
            "Type": "Abrasive cut-off wheel"
          }
        }
      },
      {
        name: "Diamond Compound Abrasive Lapping Compound Polishing Paste",
        tagline: "Premium diamond paste for rapid material removal",
        image: "/images/products/crms/diamond-compound-abrasive-lapping-compound-polishing-paste.webp",
        gallery: ["/images/products/crms/diamond-compound-abrasive-lapping-compound-polishing-paste.webp"],
        description: "Formulated with tightly graded diamond particles, this polishing paste delivers high cutting rates and superior surface finishes. Ideal for hard metals, ceramics, and composite materials.",
        features: [
          "Uniform diamond particle distribution",
          "Excellent adhesion to polishing cloths",
          "Color-coded by micron size for easy identification"
        ],
        specs: {
          "Composition": {
            "Abrasive": "Monocrystalline/Polycrystalline Diamond",
            "Base": "Oil/Water soluble"
          }
        }
      },
      {
        name: "Single crystal diamond polishing slurry",
        tagline: "Liquid diamond suspension for automated polishing",
        image: "/images/products/crms/single-crystal-diamond-polishing-slurry.webp",
        gallery: ["/images/products/crms/single-crystal-diamond-polishing-slurry.webp"],
        description: "Our single crystal diamond slurry provides a continuous and even supply of abrasive during automated polishing processes. It ensures consistent surface quality and reduces preparation time.",
        features: [
          "Stable suspension prevents settling of diamonds",
          "Compatible with automatic dosing systems",
          "Eco-friendly and easy to clean"
        ],
        specs: {
          "Suspension": {
            "Abrasive Type": "Single Crystal Diamond",
            "Carrier Fluid": "Water-based"
          }
        }
      },
      {
        name: "Diamond spray polish Metallographic Polishing Consumables",
        tagline: "Convenient diamond spray for quick and even application",
        image: "/images/products/crms/diamond-spray-polish-metallographic-polishing-consumables.webp",
        gallery: ["/images/products/crms/diamond-spray-polish-metallographic-polishing-consumables.webp"],
        description: "Diamond spray offers a practical solution for applying a thin, uniform layer of diamond abrasive onto polishing cloths. It is perfect for quick touch-ups and manual polishing routines.",
        features: [
          "Aerosol or pump spray mechanism for even coating",
          "No waste and precise application",
          "Available in various micron sizes"
        ],
        specs: {
          "Application": {
            "Method": "Spray",
            "Usage": "Metallographic final polishing"
          }
        }
      }
    ]
