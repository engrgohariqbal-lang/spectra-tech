...
export const products = [
    ...
    models: [
      {
        ...
        description: "An entry-level, highly stable CMOS-readout OES spectrometer designed for small-to-medium foundries. Low argon gas consumption combined with highly accurate calibration database makes it the best-selling model in its class.",
        features: [
      ...
      },
      {
        ...
        description: "The W5 integrates high-speed data acquisition with a thermally insulated vacuum chamber. It is optimized for detecting light elements such as Nitrogen, Carbon, Phosphorus, and Sulfur in ultra-low concentrations.",
        features: [
        ...
        specs: {
          "Optical System": {
            "Optical Structure": "Thermally stabilized Paschen-Runge vacuum optics",
            "Wavelength Range": "130nm - 800nm",
            "Focal Length": "400mm (Double grating support)",
            "Grating Lines": "2400 l/mm",
            "Detector Type": "Linear CCD/CMOS array with dynamic temperature control",
          ...
          "Physical & Environmental": {
            ...
            "Working Temperature": "10°C - 35°C (Internal thermo-regulation to 35°C ±0.5°C)"
          }
        }
      },
      {
        ...
        description: "Our flagship vertical OES spectrometer, designed for high-end laboratories. It offers absolute precision across a wide wavelength spectrum, measuring trace impurities in high-purity copper, aluminum, nickel, and steel alloys with unmatched repeatability.",
        features: [
        ...
        specs: {
          "Optical System": {
            "Optical Structure": "Vertical Paschen-Runge double optical chamber system",
            "Wavelength Range": "120nm - 800nm (covers VUV region)",
            "Focal Length": "500mm",
            "Grating Lines": "3600 l/mm (high resolution)",
            "Detector Type": "Scientific-grade deep-cooled back-thinned CCD array",
          ...
          "Physical & Environmental": {
            ...
            "Working Temperature": "15°C - 30°C (Internal chamber kept at 38°C ±0.1°C)"
          }
        }
      }
    ]
    ...
    models: [
      {
        ...
        description: "The SP6 is a top-tier mobile analyzer offering rapid steel sorting and carbon analysis in the field. It features a lightweight hand probe, high-brightness touchscreen, and intuitive grade database matching.",
        features: [
    ...
    models: [
      {
        ...
        description: "The JX5 is an optimized handheld XRF for fast sorting of common stainless steels, tool steels, and copper/bronze alloys. Standard software covers over 25 elemental channels.",
        features: [
        ...
        specs: {
          "Excitation Source": {
            "X-Ray Tube": "Miniature 40kV silver (Ag) or tungsten (W) anode tube",
          ...
          "Element Analysis": {
            ...
            "Measurement Time": "3 - 10 seconds for standard alloy identification"
          },
          "Physical & Safety": {
            "Weight": "1.5 kg (with battery)",
            "Display": "4.3 inch color transflective touchscreen",
            "Radiation Safety": "Automatic tube shutoff when no sample is detected"
          }
        }
      },
      {
        ...
        description: "Our premium handheld XRF analyzer. The JX6 features a larger area SDD detector, enabling extreme sensitivity to light elements like Magnesium, Aluminum, Silicon, Phosphorus, and Sulfur without vacuum or helium purging.",
        features: [
        ...
        specs: {
          ...
          "Detector System": {
            "Detector Type": "Large-area scientific SDD with thermoelectric cooling",
          ...
          "Physical & Safety": {
            ...
            "Communication": "Wi-Fi, Bluetooth, USB interface for report generation"
          }
        }
      }
    ]
  },
  {
    ...
    models: [
      {
        name: "CS-8820S",
        tagline: "Infrared Carbon-Sulfur analyzer with high-frequency combustion",
        image: "https://picsum.photos/seed/spectratech-cs-8820s/600/400",
        description: "The CS-8820S is designed for precise carbon and sulfur analysis in steel, iron, ores, alloys, and other inorganic materials. It features a dual carbon and dual sulfur NDIR detection setup for covering both high and low concentration ranges.",
        features: [
      ...
      },
      {
        ...
        description: "A dual-furnace carbon and sulfur analyzer combining a resistance furnace and high-frequency induction furnace in one unit. Designed for labs requiring testing on both metallurgical alloys and organic solids like coal, coke, soil, and oil.",
        features: [
        ...
        specs: {
          ...
          "Cycle Time": {
            "Combustion time": "Approx. 40 - 120 seconds (dependent on sample type)"
          },
          "Physical": {
      ...
      },
      {
        ...
        description: "Reliable workhorse for daily production QC in steel mills. Built with high-durability solenoid valves, an easily accessible dust trap, and a heavy-duty NDIR cell block.",
        features: [
      ...
      },
      {
        ...
        description: "Uses impulse furnace heating to melt specimens in a graphite crucible. Under high temperature, Oxygen forms CO, Nitrogen is released as N2, and Hydrogen as H2. Detected via highly sensitive IR and thermal conductivity cells.",
        features: [
  ...
  },
  {
    ...
    longDescription: "Energy Dispersive X-ray Fluorescence (EDXRF) benchtop spectrometers are perfect for laboratory research and production QC. Delivering rapid chemical composition verification for solids, liquids, and powders, EDXRF bridges the gap between handheld point-and-shoot analysis and large scale OES labs.",
    ...
    models: [
      {
        ...
        description: "Our top-of-the-line desktop EDXRF system featuring a high-flux 50W X-ray tube and large area SDD detector. The system supports full vacuum sample chamber operation to analyze light elements (F to Mg) with outstanding sensitivity.",
        features: [
        ...
        specs: {
          ...
          "Sample Chamber": {
            "Chamber Type": "Large vacuum chamber (air, vacuum, or helium atmosphere)",
            "Sample Changer": "10-position or 12-position motor driven carousel"
          },
          "Physical": {
      ...
      },
      {
        ...
        description: "Specifically calibrated for RoHS (Lead, Cadmium, Mercury, Chromium, Bromine) screening and heavy metals testing in consumer goods, plastics, and electronics.",
        features: [
      ...
      },
      {
        ...
        description: "Widely used in jewelry stores, pawnshops, and refineries for non-destructive karats evaluation (Au, Ag, Pt, Pd, Cu, Zn). Points out gold coatings and under-karat items instantly.",
        features: [
      ...
      },
      {
        ...
        description: "Designed for plating line thickness analysis. Measures multi-layer platings (e.g., Gold over Nickel over Copper) on PCB boards, screws, electrical connectors, and auto parts.",
        features: [
        ...
        specs: {
          ...
          "Measurement Capabilities": {
            "Plating Layers": "Up to 5 layer thickness and alloy percentage tracking",
    ...
    models: [
      {
        ...
        description: "The ICP-7000 is a dual-view (Axial + Radial) system. Axial view offers the lowest limits of detection for trace elements (ppb levels), while Radial view prevents detector saturation for major minerals (ppm/percentage levels).",
        features: [
        ...
        specs: {
          "Optical System": {
            ...
            "Detector Type": "Scientific megapixel Charge Injection Device (CID)"
          },
          "RF Generator": {
          ...
          "Sample Introduction": {
            ...
            "Peristaltic Pump": "3-channel or 4-channel speed variable software-controlled pump"
          },
          "Physical & Utility": {
      ...
      },
      {
        ...
        description: "Designed for contract testing laboratories processing hundreds of samples daily. Equipped with high-speed sample autosamplers, rapid-flush spray chambers, and intelligent background subtraction software.",
        features: [
        ...
        specs: {
          ...
          "Utility Requirements": {
            ...
            "Cooling Water": "Recirculating water chiller (cooling capacity > 2kW)"
          },
          "Physical": {
    ...
    models: [
      {
        ...
        description: "Traceable reference calibration blocks (OES standard disks) and liquid multi-element standards (ICP-OES standard solutions). Every standard comes with a detailed certificate of analysis indicating exact values and uncertainties.",
        features: [
      ...
      },
      {
        ...
        image: "https://picsum.photos/seed/spectratech-consumables-tubes/600/400",
        description: "Maintain your analyzer's performance with premium wear parts. We manufacture carbon/sulfur ceramic crucibles, tungsten spark electrodes, ICP demountable quartz torches, and spray nebulizers matching major manufacturer specifications.",
        features: [
        ...
        specs: {
          "Ceramic Crucibles": {
            ...
            "Pre-baking requirement": "Recommended pre-baking at 1000°C for 2 hours for ultra-low carbon testing"
          },
          "Electrodes": {
